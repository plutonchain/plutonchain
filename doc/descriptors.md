# Support for Output Descriptors in PlutonCoin Core

Since PlutonCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `plc1...` for mainnet or `tplc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on PlutonCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing PlutonCoin Core wallets, a convenience function `combo` is
