...
"""Verify that starting plutoncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start plutoncoin with -h for help text")
        ...
        self.log.info("Start plutoncoin with -version for version information")
        ...
        self.log.info("Start plutoncoind with -fakearg to make sure it does not start")
