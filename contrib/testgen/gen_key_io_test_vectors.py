...
bech32_templates = [
  ...
  ('plc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('plc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('plc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tplc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tplc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tplc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rplc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rplc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rplc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tplc',  17, 32, False, False, False),
  ('rplc',  3,  1, False, False, False),
  ('plc',   15, 41, False, False, False),
  ('tplc',  0, 16, False, False, False),
  ('rplc',  0, 32, True,  False, False),
  ('plc',   0, 16, True,  False, False),
  ('tplc',  0, 32, False, True,  False),
  ('rplc',  0, 20, False, False, True)
]
