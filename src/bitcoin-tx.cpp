...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " plutoncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  plutoncoin-tx [options] <hex-tx> [commands]  Update hex-encoded plutoncoin transaction\n" +
            "or:     plutoncoin-tx [options] -create [commands]   Create hex-encoded plutoncoin transaction\n" +
            "\n";
